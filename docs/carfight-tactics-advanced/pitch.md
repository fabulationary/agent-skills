...
> **Design authority:** Drafted by the Game Systems Designer for the CARFIGHT franchise; reviewed and **approved by the Showrunner**, with all required revisions incorporated in this document. Canon vocabulary and naming are locked per Showrunner ruling. This is the approved concept of record; the full GDD follows.

**Status:** Approved concept pitch. Not a GDD.

---

## LOGLINE

**A turn-based hex-grid car combat roguelite where every trigger pull is a spin of the world's own slot machine — and your whole build, crew, and legend exist to rig it.** Convoy inward from the Rim through regions that agree with you less and less, spend fuel and bullets you cannot replace mid-run, and come home to bank what lasts: research, reputation, and the ballads that make you harder to kill — and harder to be anyone else.
...
## THE HOOK: THE TUMBLER (Slot-Machine Resolution, Played Straight and Played Deep)

Every contested action in CARFIGHT TACTICS ADVANCED — every shot, ram, stunt, gadget activation, and hazard save — resolves on **the Tumbler**: a three-reel slot machine rendered big, loud, and tactile at the bottom of the touchscreen.

This is not a random-number generator with chrome on it. It is the franchise's core idea made mechanical. In CARFIGHT, what happens is what the situation most credibly *expects* to happen — an outcome is shaped by you, by your machine, and by whatever the local world is currently willing to agree is true. The three reels are exactly that:
...
**Depth changes the reels, not the rules.** Two constraints hold the starting band honest, and both are load-bearing design:
...
**One rulebook, every depth.** In Rim arenas the Tumbler is ~90% deterministic and plays like a crisp tactics game. By the Blur, the WORLD reel is a carnival. Nothing about the rules changes — only how much the world argues back. That is the franchise thesis as a difficulty curve.
...
- **Enemy reels are open.** Tap any hostile before it acts and inspect its strips. Reading the enemy's reels is scouting; changing them (DOUBT, suppression, dazzle rounds, called shots to optics) is the second layer of the tactics game.

---

## PILLARS

1. **The spin is honest.** No hidden dice, ever. Every probability is a visible face on a visible reel, and every buff, part, ballad, and region is legible as faces added or removed. If a designer can't express a mechanic as reel faces, it doesn't ship.
...
**Minute (one turn):** Read initiative → move on the hex grid under momentum rules → position facings → commit actions → spin, rig, and ride the Tumbler → watch damage land on specific plates and parts.

**Session (one battle, 6–12 min):** One arena, one objective (duel, convoy breach, toll-run, salvage snatch, hazard survival). Battles end decisively: stop, submission, escape, or wreck. Resumable at any turn — a mobile mandate.
...
- **BALLADS** — the big one. See Economy. Your deeds become verses; verses become permanent reel faces; and the songs start deciding who you are.
...
- **Stunts** (handbrake turns, drift-slides, ramps, deliberate sideswipes) are movement actions resolved on the Tumbler — driver skill loads the CREW reel, suspension loads MACHINE, surface loads WORLD. A held HOLD on a bootlegger reverse is the most stylish thing a thumb will do all week.
...
- **Temperaments** shape rigging style: a *Zealot* HOLDs cheap but may refuse to DOUBT; a *Skeptic* is a DOUBT battery but caps CALL IT; a *Showboat* earns double NERVE from stunts and feeds the ballad economy. Temperament vs. region matters — Skeptics are gold in the deep bands and merely rude in the Rim.
- **Injuries are persistent debuffs** (a winged gunner adds MISS faces until rested at a settlement), and **death is permanent**. Between runs, drivers heal, train, and — if the ballads name them — start developing ECHO faces of their own. Famous drivers are stronger and less obedient, which is the theme, priced.
...
**Canon cameos:** the series leads — **GUNBUNNY, GEARHEAD, and TINKERTECH** — appear as rare recruitable legends, and their kits are their characters: GUNBUNNY is the game's deepest DOUBT battery and its most expensive CALL IT (she doesn't call shots she hasn't already made); GEARHEAD's maintenance aura sheds JAM faces from every Kept part in the convoy; TINKERTECH's gadgets run hotter and stranger than their labels, in both directions. Recruiting all three onto one crew is the endgame flex the community will chase.
...
| **Kite** | Ultralight, rocket-glider, autogyro | Inward salvage, flown in Drift-band arenas and deeper only — haul one out to the Rim and it simply will not fly; the sky is not load-bearing out here. Occupies the air layer: immune to ground hazards and rams, capped altitude, fragile, lands to reload, and goes soft faster than anything else you can own |
...
- **Inward salvage** (the sci-fi shelf: arc-casters, grav snares, phase claddings, the wasteland's "maybe" gadget tradition): never manufactured, only recovered on runs, and it *remembers where it's from*. Every inward piece carries a **provenance depth** and a hidden **quirk** discovered through play (double-edged, always thematic). Inward gear is spectacular and it **goes soft** — the travelers' word for the day your trusted gear starts obeying the neighborhood instead of the label. Carry it too long, too deep, or into a region that flatly disagrees with it, and its MACHINE reel visibly sprouts DRIFT faces. Well-kept gear goes soft slower — maintenance is love, and love is armor.
- **The settling rule:** freshly recovered inward salvage is **Unsettled** for a stretch after recovery — Rim custom says nine days in an iron shed, and Rim custom is not always consulted. Mount it now and it's stronger and stranger (extra TRUE faces *and* extra DRIFT faces); let it settle in the garage and it becomes a lawful, known part. The forbidden fruit, ported straight into a roguelite pick-up decision.
...
| Grav snare | Inward salvage (Churn) | Light / very high / 2 charges | Nulls a target's momentum for a round; adds DRIFT to *your* next movement spin — borrowed physics splashes |
...
Arenas are the TV show's regions and settlements, ordered along the world's bands: **Rim → Drift → Churn → Blur**. Physics reliability degrades inward — concretely, the WORLD reel gains wild faces and each region rewrites one movement or resolution rule to match its ruling faction's creed. In Rim arenas every twist and hazard stays strictly plausible; the strange starts past the line. One line each:
...
| **Hourglass Terraces** | Churn/Blur | The Hourglass Cities | Physics runs on recitation: movement and resolution rules mutate on a strict, visible metronome cycle | The Chime — every N rounds the arena re-rules itself on schedule; survivors are the ones who kept count |
| **Weighed Roads** | Blur approach | Order of the Weighed Heart | Nothing here is haggled for free: every HOLD, NUDGE, and DOUBT you spend is tallied as visible Debt | Debt collectors — retribution strikes that target whoever has bent the battle most |
...
| **Court of the Answer** *(final run tier)* | Blur/deepest | *Withheld* | The WORLD reel is wider than the screen | Withheld for the GDD — final-tier content, and the pitch keeps the show's secrets |

Design rule for all arenas: **the old highways stay honest.** On-road hexes are always the most physics-stable ground in every region, at every depth. Leaving the road is always a choice with a price. This is the franchise's oldest promise, kept in level design.
...
2. **The road in (nodes):** each node is a battle arena, a waystation (barter, patch repairs, rumors), a hazard crossing (resolved as convoy-scale Tumbler spins), or an **event** written the way the Rim talks. Deeper columns of the map pay better and agree with you less.
...
5. **Homecoming:** sell, settle (or don't), research, commission ballads, bury or promote drivers, next contract.
...
- **RESEARCH:** teardown of hauled-home salvage. Unlocks frames, mounts, bench recipes, and new reel-manipulation techniques. Research cost scales with provenance depth — understanding the deep is expensive because it should be.
...
- **The Tumbler as bottom sheet:** action resolution slides up as a thumb-zone panel — reels big enough to read, HOLD/NUDGE/DOUBT as buttons under each reel, spin by swipe (with an auto-spin toggle, because commutes). The whole hook lives where the thumb lives.
- **Godot fit:** 2D isometric with pre-rendered 3D vehicle sprites (8 facings × damage states) — Godot's 2D pipeline, TileMap layers, and shader stack handle this natively and cheaply on mid-tier phones; the Tumbler is a Control-node UI scene, trivially portable to tablets. Deterministic, seeded, replayable battle logic is the vertical slice's first milestone — it is the foundation of save-anywhere and of async challenge features.
- **Session honesty:** save-and-exit any turn, battles sized for transit rides, aggressive battery posture (30fps cap out of combat, no always-on particles), and full offline play for the core run loop.
...
- **One resolution system.** Everything spins the Tumbler — no side minigames, no second combat mode, no on-foot layer at launch.
- **No multiplayer at launch.** Seeded async challenge runs ("beat my spin log") are the cheap, on-theme PvP-adjacent feature for later.
- **Monetization firewall (franchise policy for this title):** premium or cosmetic-only. A game whose hook is a slot machine must be untouchable on gambling optics: **no real-money purchase may ever add, remove, or weight a reel face.** Written in ink.
- **Canon gate:** all region flavor text ships at the altitude the Rim talks at; the localization pipeline gets a franchise canon-reviewer gate; unexplained hazards stay unexplained — no codex entries, achievement names, or patch notes that wink at them.

---

## RISKS & MITIGATIONS (named now, so the greenlight is honest)

- **Gambling optics.** A slot machine hook on mobile will draw scrutiny from platforms, press, and ratings boards. Mitigation: no real-money interaction with reels, ever (see guardrails); all odds fully visible pre-spin (the anti-slot-machine slot machine — a fairness disclosure most tactics games don't offer); rating submissions framed around "visible probability manipulation," which is our genuine design truth.
...
- **Turn-time bloat on mobile.** Enemy phases and reel ceremonies can drag. Mitigation: battle size caps, parallel enemy resolution animation, auto-spin toggle, and a hard internal budget — median player turn under 30 seconds, full round under 90.
- **Scope gravity.** Seven frame classes, twelve regions, and an air layer is a AAA menu on a mobile budget. Mitigation: the launch guardrails above are the contract, not a wish — five regions, five frames, one resolution system.
...
- **Secondary:** mobile tactics/roguelite players (*Into the Breach* mobile, *Slay the Spire* mobile, *Warbits*, auto-battler graduates) who have never seen the show; the Tumbler is a marketable hook in a screenshot and a 15-second clip.
- **Transmedia function:** the game is the franchise's *hands-on lore instrument*. Regions ship as content seasons that can track the show's map reveals; ballads give community marketing an in-world voice ("this week the wasteland sings about..."); and nothing in it spoils what the show hasn't aired.

---

## WHY THIS GAME, WHY NOW

The TV series sells the world's question; this game hands the player the lever. A game can do what a show cannot: let the player feel the world agreeing — and arguing back — every single turn, under their thumb. The Tumbler is a franchise hook no competitor can copy without our canon to justify it, the hex-momentum layer gives it tactics-genre depth, and the ballad economy turns retention mechanics into the IP's actual theme: you are what the wasteland sings about you. It fits a phone, it fits a commute, and it fits the world.

---

*End of concept pitch. Full GDD (systems math, reel-face tables, arena specs, economy tuning, Godot technical plan) follows under the approved vocabulary.*
