...
export const ITEMS: Record<string, ItemTemplate> = {
  ...
  scrub: {
    ...
    desc: 'Wipes all trace on this tier. Machines only.',
  },
  baffle: {
    kind: 'baffle', name: 'SCENT BAFFLE', sprite: 'baffle', charges: 1, weight: 4,
    desc: 'Every biosynth loses your trail. Does nothing to machines.',
  },
  emp: {
    kind: 'emp', name: 'EMP CHARGE', sprite: 'emp', charges: 1, weight: 5,
    desc: 'Locks every machine in sight for 4 turns. Does nothing to the grown.',
  },
  ampoule: {
